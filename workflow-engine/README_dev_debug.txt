...
Then in Eclipse:
    ...
    Run -> Debug Configurations -> Remote Java Application -> Create new by double click
        Name: workflow-engine remote debug
    ...
    Hit Apply and close or debug to start (the next time you won't need to recreate the configuration - just go to Run -> Debug Configurations -> Remote Java App -> workflow-engine remote debug
