<%@ tag import="com.da.activiti.model.document.DocType" %>
...
<spring:eval expression="T(com.da.activiti.workflow.WFConstants).TASK_ID_DOC_APPROVAL" var="docApprovalTask" />
<spring:eval expression="T(com.da.activiti.workflow.WFConstants).TASK_ID_DOC_COLLABORATE" var="docCollaborateTask" />
<spring:eval expression="T(com.da.activiti.workflow.WFConstants).TASK_ID_USER_APPROVAL" var="userApprovalTask" />
